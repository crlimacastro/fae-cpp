...
namespace fae
{
    auto to_string(wgpu::FeatureName feature_name) noexcept -> std::string
    {
    ...
    auto to_string(wgpu::AdapterType adapter_type) noexcept -> std::string
    {
        switch (adapter_type)
        {
    ...
    auto to_string(wgpu::BackendType backend_type) noexcept -> std::string
    {
        switch (backend_type)
        {
    ...
    auto format(std::uint64_t num) noexcept -> std::string
    {
...
#ifndef FAE_PLATFORM_WEB
    auto to_string(wgpu::LoggingType value) noexcept -> std::string
    {
        switch (value)
        {
    ...
    auto to_string(wgpu::ErrorType value) noexcept -> std::string
    {
        switch (value)
        {
    ...
    auto to_string(wgpu::DeviceLostReason value) noexcept -> std::string
    {
        switch (value)
        {
