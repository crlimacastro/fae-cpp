	...
	step.resources.use_resource<fae::webgpu>(
		[&](fae::webgpu &renderer)
		{
			renderer.current_render.vertex_data = std::vector<float>{
				...
				-.5f, .5f, .5f, 1.f, 		1.f, 0.f, 1.f, 1.f,			0.f, 1.f, // 4 left up front
				-.5f, -.5f, .5f, 1.f,		0.f, 1.f, 1.f, 1.f,			0.f, 0.f, // 5 left down front
				.5f, -.5f, .5f, 1.f,		0.f, 0.f, 0.f, 1.f,			1.f, 0.f, // 6 right down front
